...
*/
/*  Copyright 2015-2017  wp importer (email : raghunath.0087@gmail.com)
...
<div class="wrap">
	...
	<ol>
		...
		<li>* An option to define featured image for each post</li>
		<li>* An option to define category name for each post</li>
		<li>* An option to define unlimited custom fileds value</li>
		<li>* An option to define custom taxonomy name for each post</li>
