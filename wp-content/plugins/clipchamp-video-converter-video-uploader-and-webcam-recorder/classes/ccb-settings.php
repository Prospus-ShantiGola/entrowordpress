	...
	class CCB_Settings extends CCB_Module {
		...
		public function register_settings() {
            ...
            add_settings_field(
                ...
                'ccb_settings_style',
                'ccb_section-style',
                array( 'label_for' => 'ccb_field-theme' )
            );
            ...
            add_settings_field(
                ...
                'ccb_settings_style',
                'ccb_section-style',
                array( 'label_for' => 'ccb_field-style-url' )
            );
            ...
            add_settings_field(
                ...
                'ccb_settings_style',
                'ccb_section-style',
                array( 'label_for' => 'ccb_field-style-text' )
            );
            ...
            add_settings_field(
                ...
                'ccb_settings_dropbox',
                'ccb_section-dropbox',
                array( 'label_for' => 'ccb_field-dropbox-folder' )
            );
		...
		public function validate_settings( $new_settings ) {
             ...
             * Style Settings
             */
            if ( ! empty( $new_settings['style']['field-theme'] ) ) {
                $new_settings['style']['field-style-url'] = $new_settings['style']['field-theme'];
                unset( $new_settings['style']['field-theme'] );
            }
