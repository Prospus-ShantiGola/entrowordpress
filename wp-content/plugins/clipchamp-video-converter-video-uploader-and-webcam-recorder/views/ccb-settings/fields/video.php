...
<?php if ( 'ccb_field-dropbox-folder' == $field['label_for'] ) : ?>
    ...
    <input id="<?php esc_attr_e( 'ccb_field-dropbox-folder' ); ?>" name="<?php esc_attr_e( 'ccb_settings[dropbox][field-dropbox-folder]' ); ?>" class="regular-text" value="<?php esc_attr_e( $dropbox['field-dropbox-folder'] ); ?>" />
    <p class="description">(Optional) Target folder for Dropbox upload. If specified, uploaded files will be placed in this folder. Relative to the globally configured root folder. If the folder doesn't exist, it will be created. Can be specified as a '/'-delimited path, or (e.g. if you have '/' in a folder name) using an array of strings.</p>
