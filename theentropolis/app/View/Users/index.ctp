        ...
        <div class="home-display row">
            <div class="col-md-12">    
                <div class="margin-bottom">
                    <p>Your private collection of wisdom to save for future reference. Build a comprehensive reference archive of valuable and up to date Educator Experience and Mentor wisdom from our continually expanding database to help you make better business decisions, expand your knowledge and identify connections at critical points in your entrepreneurial journey.</p>
                </div>            
                    ...
                    <div class="cat-right-col">
                        ...
                        <div class="tab-content-hindsight">
                            ...
                            <div class="tab-pane active" id="all-hindsights">
                                ...
                                <table class="table table-striped advices-table library-wrap script-call main-table-wrap table-condensed  remove-scroll tableHT">
                                    <thead>
                                        <tr>
	...
	jQuery('body').on('click','.edit-advice-mylibrary',function(e){
      ...
      alert(blog);
        if(blog == 0 || blog == "")
        {
            ...
            if($("#new-advice-"+data_id).find(".create-advice").is(":checked"))
            {
               alert('tr')
          ...
          else
            {
                ...
                $("#new-advice-"+data_id).find(".create-advice").attr('checked',true);
                $("#new-advice-"+data_id).find(".feature-blog").attr('checked',false);
                $("#new-advice-"+data_id).find(".advice-wrapper-post").show();
                $("#new-advice-"+data_id).find(".feature-blog-wrapper-post").hide(); 
            }
        }
        else
        {
            ...
            if($("#new-advice-"+data_id).find(".create-advice").is(":checked"))
            {
                $("#new-advice-"+data_id).find(".create-advice").attr('checked',false);
                $("#new-advice-"+data_id).find(".feature-blog").attr('checked',true);
