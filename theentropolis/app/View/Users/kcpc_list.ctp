...
<div class="col-md-10 content-wraaper en-content-wrap">
    <div class="sage-dash-wrap full-wrap">
        <div class="title dashboard-title fixed-ipad-top">
            <h1>COMPETITION SUBMISSION LIST - KIDPRENEUR CHALLENGE</h1>
        </div>
        <div class="home-display row">
            <div class="col-md-12">
                <div class="title_text">
                    
                    <p class="cred-para">Kidpreneur Challenge Pitch Competition - Schools entries master list.</p>
                                ...
                                <button type="button" class="btn search-bar-button1 btn-black hide" onclick="search();">Go</button>
                                 <?php
                                    echo $this->Html->link(
                                            'Download CSV', array(
                                        'controller' => 'Users',
                                        'action' => 'downloadkcpcfile', //action name
                                        'full_base' => true,
                                            ), array(
                                        'label' => false,
            ...
            <div class="col-md-12  ">
                <div class="ask-ques-wrap clearfix margin_top_none" style="overflow: hidden">
...
<script type="text/javascript">
    ...
    function getListData(tabname, decision_type_id, type, load_row, name, email)
    {
        ...
        jQuery.ajax({
            url: '<?php echo $this->webroot ?>users/get_kcpc_user_list/',
            data: {
                'tab_name': tabname,
