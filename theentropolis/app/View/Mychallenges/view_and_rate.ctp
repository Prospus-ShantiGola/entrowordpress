                ...
                <div>
                        <div class="view-right-panel">
                                ...
                                <div class="align-right">
                                        ...
                                        <a href="<?php echo Router::url(array('controller'=>'mychallenges', 'action'=>'share', $hindsights['Hindsight']['id']))?>" class="btn btn-black margin-top-small large">Share Hindsight</a>
		  ...
		  <div class="modal-dialog">
		    <div class="modal-content">
		        ...
		        <div class="modal-footer my_challenge">
			        ...
			        <a href="<?php echo  Router::url(array('controller'=>'mychallenges', 'action'=>'index'))?>" class="btn btn-black">Do Another Search</a>
