                ...
                <div class="col-md-12">
                    <div class="upper-links align-right clearfix">                        
                        <div class="dropdown">
                            ...
                            <span class = 'header-user-name' >Chris Savage<i class="fa fa-angle-down"></i>
                            </a>
            ...
            <div class="col-md-2 sidebar-wrapper ">
                <div class="sidebar">
                    <div style="text-align:center; margin:15px;">
                        <?php echo $this->Html->image('theentropolis-logo.png', array('alt'=>'entopolis'));?>  
                    </div>
                    <ul class="nav row sidebar-nav">
                        <li><a href="#" class="active"><i><?php echo $this->Html->image('dashboard.png', array('alt'=>'entopolis'));?></i>Dashboard</a></li>
                        ...
                        <li><a href="#"><i><?php echo $this->Html->image('Librarie.png', array('alt'=>'entopolis'));?></i>My|Library</a></li>
                        <li><a href="#"><i><?php echo $this->Html->image('wisdom-search.png', array('alt'=>'entopolis'));?></i>Wisdom|Search</a></li>
                        <li><a href="#"><i><?php echo $this->Html->image('cred-street.png', array('alt'=>'entopolis'));?></i>Cred|Street</a></li>
                        <li><a href="#"><i><?php echo $this->Html->image('setting.png', array('alt'=>'entopolis'));?></i>Settings</a></li>
                    </ul>
...
<?php 
    echo $this->element('hindsight_js_element'); 
