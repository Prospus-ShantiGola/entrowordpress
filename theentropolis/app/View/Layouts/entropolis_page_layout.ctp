...
<head>
    ...
    <meta property="og:url" content="https://dev.trepicity.com/heroes" />
    <meta property="og:image" content="https://dev.trepicity.com/app/webroot/img/entr_fb_share.png" />
...
<meta name="twitter:image" content="https://dev.trepicity.com/app/webroot/img/entr_fb_share.png">
...
<!--       <script src="https://www.protonotes.com/js/protonotes.js" type="text/javascript"></script>-->
	...
	$('#social-tabs').dcSocialTabs({
						...
						widgets: 'fblike,twitter,youtube,linkedin',
						fblikeId: '480733462050179',
						twitterId: 'Entropolis',
						youtubeId: 'UCdmp9bClSJcsEiuKJ9_Gd3g',
						linkedinId: '3631845,https://www.linkedin.com/in/leechestnutt',
						start: 3,
                                                fblike:{
			    limit:0,
			    stream: true
...
<body class="fusion-body">
  ...
  <div class="topstrip">
    <div class="col-md-3"><a href="<?php echo Router::url(array('controller'=>'pages', 'action'=>'index'));?>">
      ...
      <?php echo $this->Html->image('logos/entropolis-logo.png', array('style' => '','border' => '0','alt' => 'Entropolis')); ?>
    </a></div>
    <div class="col-md-9">
      <div id="navico">
      ...
      <div id="navmenu">
        <div class="menuLeft">
              <ul class="nav navbar-nav mainmenu">                     
                    ...
                    <li id="phplive-img-resize">
                           <!-- BEGIN PHP Live! HTML Code -->
<span style="color: #0000FF; text-decoration: underline; cursor: pointer;" id="phplive_btn_1525927400" onclick="phplive_launch_chat_0()"></span>
<script data-cfasync="false" type="text/javascript">

(function() {
var phplive_e_1525927400 = document.createElement("script") ;
phplive_e_1525927400.type = "text/javascript" ;
phplive_e_1525927400.async = true ;
phplive_e_1525927400.src = "//theentropolis.com/app/webroot/phplive/js/phplive_v2.js.php?v=0|1525927400|0|" ;
document.getElementById("phplive_btn_1525927400").appendChild( phplive_e_1525927400 ) ;
})() ;
        ...
        <div class="menuRight">
            ...
            <?php if ($this->Session->read('user_id') > 0) { ?>
                        ...
                        <?php } else { ?>
                                ...
                                <a class="btn btn-default btnblue login" href="#myModal" data-toggle="modal">LOG IN</a>
         <a class="btn btn-default btnblue btnfilled signup" href="#citizenAccount"  data-toggle="modal">SIGN UP</a>
                        <?php } ?>
