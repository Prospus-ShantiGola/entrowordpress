<div class="col-md-10 content-wraaper">
  <div class="sage-dash-wrap full-wrap">
    <div class="title dashboard-title fixed-ipad-top">
        <h1 style="text-transform:uppercase;margin-top:0px !important">Entropolis | Curated</h1>
    </div>
...
<!--            <h2 class="orange">Entropolis | Curated</h2>-->
                ...
                <div class="cat-right-col">
                    <div class="tab-content-hindsight">
                        ...
                        <div class="tab-pane active" id="all-hindsights">
                            <table class="table table-striped table-condensed remove-purpel my_decisionbank my_challenge expert_advices tableHT ">
                                <?php 
      ...
      jQuery.ajax({
           ...
           success:function(data){
            ...
            $('ul.tabs li').removeClass('active');
             ...
             $("li[data-id='" + decision_type_id + "']").addClass('active');   
