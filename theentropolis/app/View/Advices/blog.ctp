        ...
        <div class="col-sm-7">
            <div class="blogBlock">
                ...
                <div style="margin:1.5em 0 1.5em;">
                    <a href=""> <?php echo $this->Html->image('facebook-blog.png', array('data-alt-src' => 'img/facebook-over.png', 'class' => 'imgswop', 'border' => '0')); ?></a>&nbsp;
                    <a href=""><?php echo $this->Html->image('twitter-blog.png', array('data-alt-src' => 'twitter-over.png', 'class' => 'imgswop', 'border' => '0')); ?></a>&nbsp;
                    <a href=""><?php echo $this->Html->image('youtube-play-blog.png', array('data-alt-src' => 'youtube-play-over.png', 'class' => 'imgswop', 'border' => '0')); ?></a>&nbsp;
                    <a href=""><?php echo $this->Html->image('linkedin-blog.png', array('class' => 'imgswop', 'data-alt-src' => 'linkedin-over.png', 'border' => '0')); ?></a>
                </div>
                ...
                <div class="mediaL">
                    ...
                    foreach ($blog_list as $k => $v) {
                        if ($v['Advice']['blog_type'] == 6) {
                            $user_info = $this->User->getDetailByContextRoleUserId($v['Advice']['context_role_user_id']);?>
                            <a href="javascript:void(0);" class ="get-new-modal" data-type="advice" data-id ="<?php echo $v['Advice']['id'] ;?>" data-advice-type="<?php echo $v['Advice']['blog_type'];?>"data-advice-type="Archived Post" data-counterid="11" data-clickcount="3">
                            <?php echo (($v['Advice']['advice_image'] == "") ? $this->Html->image("blog-sample.jpg", array('alt' => '', 'border' => '0', 'width' => '100%')) : $this->Html->image($v['Advice']['advice_image'], array('alt' => '', 'border' => '0', 'width' => '100%')));
                            ?>
                            <div class="blogMainTitle"><?= $v['Advice']['advice_title'] ?></div>
                            <div class="blogAuthor"><?php echo $user_info[0]["users"]['first_name']." ".$user_info["users"]['last_name'] ?></div>
                    ...
                    <div class="blog_media_wrap custom_scroll">
                        ...
                        foreach ($blog_list as $k => $v) {
                            if ($v['Advice']['blog_type'] == 6) {
                                ...
                                ?>
                                <a href="javascript:void(0);" class ="get-new-modal" data-type="advice" data-id ="<?php echo $v['Advice']['id'] ;?>" data-advice-type="<?php echo $v['Advice']['blog_type'];?>"data-advice-type="Archived Post" data-counterid="11" data-clickcount="3">
                                    <div class="margin_bottom_space" style="margin: 0;">
                                        <div class="sideL">
                                            <?php echo $this->Html->image('blog-article-icon.png', array('alt' => '', 'class' => 'blogIco', 'width' => '100%', 'border' => '0')); ?>
                                        </div>
                                        <div class="sideR">
