...
function goBack() {
    window.history.back()
					...
					<div class="share-hindsight">
                                              ...
                                              <?php 
                                              //pr($adviceListInfo);
                                              if($adviceListInfo['ContextRoleUser']['User']['id']==$this->Session->read('user_id')){?>
...
<div class="addthis_sharing_toolbox"></div>
					...
					<div class="modal fade" id="share-hindsight" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
