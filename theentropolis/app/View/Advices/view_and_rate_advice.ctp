		        ...
		        <div class="view-right-panel">
		            <div class="view-right-panel-top clearfix">
		                <div class="view-right-panel-top-left">
		                    ...
		                    <span>
		                        <h4><?php echo $adviceInfoData['Advice']['advice_title']?></h4>
		                    </span>
		                    ...
		                    <!-- <span class="challenge-color">
		                        <a href="<?php echo $adviceInfoData['Advice']['source_url']?>">Source Url</a> </span> -->
		                </div>
		            ...
		            <div class="modal fade" id="thanks-rating" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
