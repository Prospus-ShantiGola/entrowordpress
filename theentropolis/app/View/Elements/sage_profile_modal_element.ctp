...
///die;
            ...
            <div class="profile_rating">
                <?php
                 ...
                 $image_icon_name = $this->Common->getRoleIcon($adviceInfoData['User']['id']);
...
<div class="row">
    <div class="col-md-12 ">
        <div class="col-md-8 ">
            ...
            <div class="profile_biography containerHeight custom_scroll">
            <p>
                <?php
                //echo strlen(@$user_info['UserProfile']['short_bio']);
                ...
                <div class="person-content short-data"><?php
                    ...
                    echo $this->Eluminati->text_cut(html_entity_decode(@$user_info['UserProfile']['short_bio']), $length = 300, $dots = true);
                ...
                <div class="person-content full-data hide"  data-to="1">
                    <?php echo html_entity_decode(@$user_info['UserProfile']['short_bio']); ?>
                </div>
                ...
                ?>
                <div class="person-content short-data"><?php echo $this->Eluminati->text_cut(html_entity_decode(@$user_info['UserProfile']['short_bio']), $length = 300, $dots = true); ?>
                </div>
            <?php } ?> 
            <?php
            ...
            <p>
                ...
                if (strlen(@$user_info['UserProfile']['executive_summary']) > 300) { ?>
                    ...
                    echo $this->Eluminati->text_cut(html_entity_decode(@$user_info['UserProfile']['executive_summary']), $length = 300, $dots = true);
                    $later_length = strlen(trim($this->Eluminati->text_cut(@$user_info['UserProfile']['executive_summary'], $length = 300, $dots = true)));
                        ?></b></strong></a></em></i></div>
                    <div class="person-content full-data hide"  data-to="1"> <?php echo html_entity_decode(@$user_info['UserProfile']['executive_summary']); ?></div>
                    <?php if ($actual_lenth != $later_length) { ?>
                        <a href="#1" class="right btn-readmorestuff">Read more</a>
                    <?php } ?><?php
                } else {
                ?>
                <div class="person-content short-data"><?php echo $this->Eluminati->text_cut(html_entity_decode(@$user_info['UserProfile']['executive_summary']), $length = 300, $dots = true); ?>
                </div>
                <?php } ?> <?php
