...
<div class="modal-dialog">
      ...
      <div class="modal-header">
       ...
       <div class="modal-body">
        <div class="elumanati-wrap">
         ...
         <?php  }
              ?>
              <h2> <?php echo $adviceInfoData['ContextRoleUser']['User']['first_name']." ".$adviceInfoData['ContextRoleUser']['User']['last_name'];?></h2>
            </div>
            ...
            <div class="col-md-7">
             ...
             <div class="col-md-5">
              <div class="elumanati-wrap-right">
                <span class = 'view_status'>Views [ <?php echo $adviceInfoData['Advice']['advice_views'] ?> ]</span>
                <span class='comment-advice'>Comments [ <?php echo $comment_cc ?> ]</span>
          ...
          <div class="row eluminti-box-wrap">
           <div class="col-md-4 align-center">
              ...
              <div class="relative">
                <div class="key-box key-box-height"></div>
                <!-- <textarea class="form-control" rows="3"></textarea>   -->
       <!--          <i class="fa fa-plus add"></i>  -->             
              </div>
              <div class="relative">
 ...
 -->         
    ...
    {?>
  <div class="eluminti-box person-content short-data"><?php 
      // echo substr($post['Escene']['post_description'], $remaining-1 );  
      ...
      $later_length =  strlen(trim($this->Eluminati->text_cut($user_info['UserProfile']['executive_summary'], $length = 300, $dots = true)));?></div>
    <div class="eluminti-box person-content full-data hide"  data-to="1"> <?php echo  nl2br($user_info['UserProfile']['executive_summary']);  ?></div>  
      <?php if( $actual_lenth != $later_length ){?>
                     <a href="#1" class="right btn-readmore"><i class="fa fa-plus add"></i> </a>
                 <?php } ?><?php
    }
   ...
   <?php }?>
     ...
     <!--     <a href="#" class="escene-action-right"><input type = "hidden" class= "obj_id" name = "obj_id" value = "<?php echo  $advice[0]['Advice']['id'];?>"><input type = "hidden" name = "obj_type" value= "Advice"><input class="atch-new" type="file" name="files[]" data-url="<?php echo Router::url(array('controller'=>'pages', 'action'=>'upload_data/'.$obj_id.'/'.$obj_type));?>"  multiple> <i class="fa fa-camera escene-action-fa"></i></a> -->
        ...
        <?php }else{?>
         <a href = "<?php echo Router::url(array('controller'=>'users', 'action'=>'login'));?>"><?php echo $this->Html->image('black-icon1.png');?></a>
        <a href = "<?php echo Router::url(array('controller'=>'users', 'action'=>'login'));?>"> <?php echo $this->Html->image('black-icon2.png');?></a>
        <a href = "<?php echo Router::url(array('controller'=>'users', 'action'=>'login'));?>"> <?php echo $this->Html->image('black-icon3.png');?></a>
...
echo $this->Html->image('dummy-pic.png');
         ...
         <?php  }
          ...
          <div class="row eluminti-box-wrap">
            <div class="col-md-4 align-center">
              <div class="relative">
                 <div class="key-box"><i><?php echo $this->Html->image('BookCover-main.png');?></i></div>
            ...
            <div class="col-md-8">
              ...
              <div class="relative" >
               ...
               <!--  <textarea class="form-control" rows="3" placeholder="Executive Summary"><?php echo $eluminati['Eluminati']['executive_summary'];?></textarea>   -->
                ...
                {?>
              <div class="eluminti-box eluminti-box1 person-content short-data"><?php 
                  // echo substr($post['Escene']['post_description'], $remaining-1 );  
                  ...
                  $later_length =  strlen(trim($this->Eluminati->text_cut($eluminati['Eluminati']['executive_summary'], $length = 300, $dots = true)));?></div>
                <div class="eluminti-box eluminti-box1 person-content full-data hide"  data-to="1"> <?php echo  nl2br($eluminati['Eluminati']['executive_summary']);  ?></div>  
                  <?php if( $actual_lenth != $later_length ){?>
                                 <a href="#1" class="right btn-readmore"><i class="fa fa-plus add"></i> </a>
                  ...
                  <div class="eluminti-box eluminti-box1 person-content short-data" placeholder="Executive Summary"><?php 
                  echo nl2br($this->Eluminati->text_cut($eluminati['Eluminati']['executive_summary'], $length = 300, $dots = true));?>
                </div>
               <?php }?>
      ...
      <div class="modal-footer align-center">
         <?php if($this->Session->read('user_id')){?>
      <a data-toggle="modal" onclick="javascript:jQuery('#add-comment').modal('show');"><?php echo $this->Html->image('icon-1.png');?></a>
      <a data-toggle="modal" onclick="javascript:jQuery('#add-rating').modal('show');"><?php echo $this->Html->image('icon-2.png');?></a>
       <a> <?php echo $this->Html->image('icon-3.png');?></a>
       <a> <?php echo $this->Html->image('icon-4.png');?></a>
       <a>  <?php echo $this->Html->image('icon-5.png');?></a>
    
        <a href="#" class="escene-action-right"><input class="atch-new post-nav-input" type="file" name="files[]" data-url="<?php echo Router::url(array('controller'=>'escenes', 'action'=>'upload'));?>"  multiple><?php echo $this->Html->image('icon-6.png');?></a>  

        <?php }else{?>
            <a href="<?php echo Router::url(array('controller'=>'users', 'action'=>'login'));?>"><?php echo $this->Html->image('icon-1.png');?></a>
              <a href="<?php echo Router::url(array('controller'=>'users', 'action'=>'login'));?>"><?php echo $this->Html->image('icon-2.png');?></a>
               <a> <?php echo $this->Html->image('icon-3.png');?></a>
               <a> <?php echo $this->Html->image('icon-4.png');?></a>
               <a>  <?php echo $this->Html->image('icon-5.png');?></a>
            
                <a href="javascript:void(0);" class="escene-action-right"><input class="atch-new post-nav-input" type="file" name="files[]" data-url="<?php echo Router::url(array('controller'=>'escenes', 'action'=>'upload'));?>"  multiple><?php echo $this->Html->image('icon-6.png');?></a>  
                ...
                <div class=" clearfix <?php echo $modal_header_color;?>">
                   ...
                   <div class="form-group clearfix">
                    ...
                    <?php if($type=='Advice'){?>
                           ...
                           <span><?php echo date('D j F Y',strtotime($adviceInfoData['Advice']['advice_decision_date']));?></span>
            ...
            success: function(resp) {
                if (resp.result == 'success') {
                  //alert(resp.error_msg);
                    ...
                    var dd = 'Comment [ '+resp.error_msg+' ] ';
                    $('.comment-advice').text(dd);
                }
                else{
                    return false;
                }
