 ...
 <?php //echo $this->Html->image('dummy-pic.png');
            ?>
            <!--   <img   src="<?php echo $this->Html->url('/').$this->Image->resize('img/avatar-male-1.png' , 60, 60, false);?>" alt=""/>     -->
         <?php  }
              ?>
                  </a>
              ...
              <?php    if($total_comment_count>1){
                       if(@$obj_type == 'DecisionBank'){
                           $type = 'Hindsight';
                           $class_var = 'btn-purpel';
                           $objId = $last_comment['Comment']['hindsight_id'];
                       }
                       else{
                           $type = 'Advice';
                           $objId = $last_comment['Comment']['advice_id'];
                            $class_var = '';
                       }
                       ?>
                    <a class="right btn btn-orange <?php echo $class_var; ?> load-more-comment-data" data-totalcount = '<?php echo $total_comment_count-1; ?>' data-count ='<?php echo $total_comment_count-1; ?>' data-startlimit= "0" data-id= "<?php echo $objId;?>" data-type ="<?php echo $type;?>" data-totalshow = "1">Load More</a>
