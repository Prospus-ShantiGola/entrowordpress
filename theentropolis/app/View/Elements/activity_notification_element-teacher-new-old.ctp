                ...
                <div class="panel-default filter">
                    ...
                    <div id="collapseOne1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne1">
                        <div class="panel-body" style="color:#000">
                            <form action="/Trepicity/hq-dashboard" class="margin-0x" id="get-filter-data-form-teacher" method="post" accept-charset="utf-8"><div style="display:none;">
                                ...
                                <div class="checkbox-btn">
                                    ...
                                    <label class="custom-radio" for="AskQuestionTeacher"><span>Ask|TrepiCity</span></label>
                                </div>
                                ...
                                <div class="filter-bottom">
                                    <input class="btn Black-Btn right filter-data-teacher " type="submit" value="Done">                               
            ...
            //if INVITATION
                ...
                //if invitation status is accepted by the user
                    ...
                    <div class="row">
                        <div class="col-md-12 activity_list">
                            <div class="col-md-7">
                                <span><strong><?php echo $output['first_name'] . " " . $output['last_name']; ?></strong><em>invited you to join <?php echo $gender_type; ?> network</em><button class="accept-btn Gray-Btn">Accepted</button></span>
            ...
            //Suggestion start
                ...
                <a href = <?php echo Router::url(array('controller' => 'askQuestions', 'action' => 'index?object_id=' . base64_encode($output["obj_id"]) . '&id=2')) ?>  > 
                    <div class="row">
                        <div class="col-md-12 activity_list">
                            <div class="col-md-7">
                                <span><strong><?php echo $output['first_name'] . " " . $output['last_name']; ?></strong><em>likes your suggestion </em></span>
                                <p><?php echo $output['comment_value']; ?></p>
                            </div>
                ...
                <a href = <?php echo Router::url(array('controller' => 'askQuestions', 'action' => 'index?object_id=' . base64_encode($output["obj_id"]) . '&id=2')) ?>  > 
                    <div class="row">
                        <div class="col-md-12 activity_list">
                            <div class="col-md-7">
                                <span><strong><?php echo $output['first_name'] . " " . $output['last_name']; ?></strong><em>commented on your suggestion </em></span>
                                <p><?php echo $output['comment_value']; ?></p>
                            </div>
