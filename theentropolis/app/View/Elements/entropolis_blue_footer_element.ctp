<!-- <div class="footerAlt">
        <div class="footerAltInner">
            ...
            <div align="center" style="margin:2em 0 4em;">
                <a href="#" class="buttonBlue dinBut  open-registration-js" data-toggle="modal" data-target="#kidpreneurChallenge" data-dismiss="modal">
                    TAKE THE CHALLENGE
                </a>
            </div>
...
<script>
        ...
        $('.carousel-showthreemoveone:not(".overlayImg")').carousel({interval: false});

    (function () {
        $('.carousel-showthreemoveone:not(".overlayImg") .item').each(function () {
            console.log('showthreemoveone');
...
console.log('test');
    ...
    var fadeImageTotal = 5; //Total number of bg images - ONLY CHANGE if bg images count changes.
    ...
    $(function () {
        $.preload([
            ...
            "img/trepi-images/banner-image5.png"
        ], {
            init: function (loaded, total) {
