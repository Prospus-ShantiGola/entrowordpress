       ...
       // pr($conadList);
        ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $this->User->userName($conadList['ContextRoleUser']['user_id']); ?></td>
                                    ...
                                    <td>
                                        ...
                                        <?php if ($conadList['ContextRoleUser']['user_id'] == $this->Session->read('user_id')) { ?> <a href="#edit-advice-<?php echo $conadList['Advice']['id']; ?>" data-toggle="modal" data-target="#edit-advice-<?php echo $conadList['Advice']['id']; ?>"><i class="fa fa-pencil"></i></a> <?php } ?>
                                    </td>
                                </tr>
