              ...
              ?>
                ...
                <?php } ?>
                   ...
                   <?php    if($total_comment_count>1){
                       ...
                       ?>
                    <a class="right btn btn-orange  load-more-comment-data" data-totalcount = '<?php echo $total_comment_count-1; ?>' data-count ='<?php echo $total_comment_count-1; ?>' data-startlimit= "0" data-id= "<?php echo $objId;?>" data-type ="<?php echo $type;?>" data-totalshow = "1">Load More</a>
