<script type="text/javascript">
            ...
            jQuery.ajax({
                ...
                success: function (data)
                {
                    ...
                    if (remaining_count == '0')
                    {
                        ...
                        jQuery("#seeker-collapseFive").find(".panel-body").append(less);
                    }
    ...
    jQuery('body').on('click', ".hide-eluminati-comment", function (e) {
        ...
        if (limit != size_li)
        {
            ...
            jQuery("#seeker-collapseFive").find(".panel-body").children("div[class=media]:last").remove();
            size_li = $(".media").size();
            if (limit == size_li)
            {
                $this.remove();
            ...
            if (comment != '') {
                jQuery.ajax({
                    ...
                    'success': function (data) {
                        ...
                        jQuery(".eluminati-comment-area").show();
                        $('.close-comment').trigger('click');
                        $('.post-comment').val('');


                        //jQuery("#seeker-collapseFive").find(".panel-body").html(data);
                        $('#eluminati-popup .popups_detail_blocks:last').html(data);
...
//# sourceURL=eluminati_js_element.js
</script>
