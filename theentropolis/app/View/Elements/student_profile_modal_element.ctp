...
<?php  $res  = $this->User->getDataById($students[0]['student']['id'],'Student');
...
<div id="eluminti-signup" class="eluminati-profile-wrap remove-other-tab" data-present= "<?php echo $data; ?>" data-advice = "<?php echo $students[0]['student']['id']; ?>">
    <div class="content">
                    ...
                    <div class="">
                        <div class="eluminti-signup-top ">
                            ...
                            <div class="eluminti-signup-top-detail profile_detail_view">
                                <span><?php echo $students[0]['student']['first_name']." ".$students[0]['student']['last_name'];?></span>
                          ...
                          <p class="person-content short-data show-link roboto_light"><?php 
                              ...
                              $later_length =  strlen(trim($this->Eluminati->text_cut($eluminati['Eluminati']['short_description'], $length = 165, $dots = true)));?></b></p>
