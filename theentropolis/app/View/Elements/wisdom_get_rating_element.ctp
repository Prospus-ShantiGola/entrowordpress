         ...
         <?php  }
              ...
              <?php    if($total_comment_count>1){
                       if(@$obj_type == 'Wisdom'){
                           ...
                           $type = 'Advice';
                           $objId = $last_comment['WisdomComment']['advice_id'];
                            $class_var = '';
                       }
                       ?>
                    <a class="right btn btn-gray <?php echo $class_var; ?> load-more-wisdom-comment-data" data-totalcount = '<?php echo $total_comment_count-1; ?>' data-count ='<?php echo $total_comment_count-1; ?>' data-startlimit= "0" data-id= "<?php echo $objId;?>" data-type ="<?php echo $type;?>" data-totalshow = "1">Load More</a>
