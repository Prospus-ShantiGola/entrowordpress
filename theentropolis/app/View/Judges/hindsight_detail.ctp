...
<div class="col-md-10 content-wraaper">		
			<div class="title dashboard-title">
				...
				<?php echo $this->Html->link('Back To List',array('controller'=>'judges','action'=>'viewChallenge',$value['challenge_id']),array('class'=>'btn btn-orange-small right')); ?>
			</div>
					...
					<div class="">
						...
						<div class="view-right-panel-description">
							...
							<div class="view-right-panel-detail">
                                                <h3>Details:</h3>
                                                <p><?php if($value['short_description']!=''){echo nl2br($value['short_description']);}?></p>
                            </div>
