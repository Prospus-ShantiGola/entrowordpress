<div class="col-md-10 content-wraaper admin-wrap">      
    <div class="sage-dash-wrap full-wrap">
        <div class="title dashboard-title">
            <h1>Videos</h1>
            <?php echo $this->Html->link('Add Video',array('controller'=>'videos','action'=>'addVideo'),array('class'=>'right btn btn-orange-small ')); ?>
        </div>   
        <?php echo $this->element('manage_video_element');?>
    </div>
