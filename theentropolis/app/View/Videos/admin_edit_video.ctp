    ...
    <div class="sage-dash-wrap full-wrap">
        ...
        <div class="invite-user-form forms font-light add-elum">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <?php echo $this->Form->input('title', array('class'=>'form-control', 'label'=>false,'value'=>$data_res['Video']['title']));?>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label">URL</label>
                <div class="col-sm-7">
                    <?php echo $this->Form->input('url', array('class'=>'form-control', 'label'=>false ,'value'=>$data_res['Video']['url']));?>
                ...
                <div class="col-sm-8">
                    <div class="attachment clearfix">
                        <div class="atch-wrapper clearfix">
                            ...
                            <input type="hidden" class="img-url"  name = "data[Video][image_url]" value = "<?php echo $data_res['Video']['upload_thumbnail']; ?>" >  
                            <div class="image-bind">
                                 <?php if( $data_res['Video']['upload_thumbnail'] != ''){ ?>
                                <img src="<?php echo $this->Html->url('/').$this->Image->resize($data_res['Video']['upload_thumbnail'] . '', 80, 80, true);?>" class = "add-post-img img-thumbnail"> 
                                <?php }else{?>
                    ...
                    <div class="brws-btn">    
                        ...
                        <input class="atch-new-image escene-action-input" type="file" name="files[]" data-url="<?php echo Router::url(array('controller'=>'videos', 'action'=>'upload'));?>"/>
                        Browse</a> 
                    </div>
                </div>
            </div>
