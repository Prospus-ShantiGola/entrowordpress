...
<div class="middle-container">
    <!-- KC kid TOOLKIT END HERE -->
    <div class="kd-layout-biz">
        <div class="col-md-10 content-wraaper black-dot  kidpreneur_toolkit  p-0" >
                    ...
                    <div class="col-md-12">
                        <div class="search-bar clearfix margin_top_15 margin_bottom_15 padding_zero">
                            <div class="toolkit_search">
                                <input type="text" placeholder="Search File" class="form-control " name="txtSearch" id="txtSearch"/>
                                            ...
                                            <div class="list_block">
                                                <div class="flex_container">
                                                    ...
                                                    <div class="third_col file_actions">
                                                        <span class="accordionTitle"><i class="icons view-big"></i></span>
                                                    </div>
                                                    <div class="fourth_col">
                                                        <small><em>
