...
<div class="modal fade " id="newFolderPopup" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php
                echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitAddForm'));
            ?>
...
<div class="modal fade " id="EditFolderPopup" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php
            echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitEditForm'));
            ?>
            <div class="modal-body clearfix">
                <?php
                echo '<div class="form-group clearfix"><div class="col-sm-12">';
...
<div class="modal fade " id="EditFilePopup" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php
            echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitEditFileForm'));
            ?>
            <div class="modal-body clearfix">
                <?php
                ...
                echo '</div></div>';
                echo $this->Form->input('old_title', array('name' => "data[KidpreneurToolkit][old_title]", 'id' => 'old_name', 'type' => 'hidden', 'value' => 'test.jpg'));
                echo '<div class="form-group clearfix"><div class="col-sm-12">';
...
<div class="modal fade " id="EditDescPopup" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php
            echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitEditDescription'));
            ?>
            <div class="modal-body clearfix">
                <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body clearfix">
                ...
                <div class="uploadPdfFields">
                    <?php
                    echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitAddPdfForm'));
                    ?>
                ...
                <div class="uploadVideoFields">
                    <?php
                    echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitAddVideoForm'));
                    ?>
                    <div class="clearfix">
                        <div class="col-sm-12">
                ...
                <div class="uploadLinkFields">
                    <?php
                    echo $this->Form->create('KidpreneurToolkit', array('id' => 'ToolkitAddLinkForm'));
                    ?>
                    <div class="clearfix">
                        <div class="col-sm-12">
...
echo $this->Html->script('kidpreneurtoolkit');
