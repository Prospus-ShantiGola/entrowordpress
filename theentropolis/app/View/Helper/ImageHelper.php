...
{ 
  ...
  var $cacheDir = 'upload'; // relative to 'img'.DS 
  ...
  function resize($path, $width, $height, $aspect = true, $htmlAttributes = array(), $return = false) { 
    ...
    $types = array(1 => "gif", "jpeg", "png", "swf", "psd", "wbmp","svg"); // used to determine image type 
    ...
    $cachefile = $this->cacheDir.DS.$width.'x'.$height.'_'.basename($path);  // location on server 
