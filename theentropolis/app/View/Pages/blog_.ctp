            ...
            <div class="blogBlock">
                <div class="blogFeaturedImgWrap">
                    ...
                    <div class="embed-responsive embed-responsive-16by9">
                          <iframe class="embed-responsive-item" src="<?=$videoUrl?>" height="400"></iframe>
                    </div>
                ...
                <div style="margin:1.5em 0 1.5em;">
                    ...
                    <a href="https://www.linkedin.com/company/trepicity-pty-ltd/" target="-blank"><?php echo $this->Html->image('linkedin-blog.png', array('class' => 'imgswop', 'data-alt-src' => 'linkedin-over.png', 'border' => '0')); ?></a>
                </div>
