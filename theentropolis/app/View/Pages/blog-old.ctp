        ...
        <div class="col-sm-7">
            <div class="blogBlock">
                ...
                <div style="margin:1.5em 0 1.5em;">
                    <a href="" class="disabled"> <?php echo $this->Html->image('facebook-blog.png', array('data-alt-src' => 'img/facebook-over.png', 'class' => 'imgswop', 'border' => '0')); ?></a>&nbsp;
                    <a href="" class="disabled"><?php echo $this->Html->image('twitter-blog.png', array('data-alt-src' => 'twitter-over.png', 'class' => 'imgswop', 'border' => '0')); ?></a>&nbsp;
