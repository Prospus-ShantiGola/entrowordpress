...
<div id="home" class="container">
            <div class="content-wrap">
                <div class="row margin-bottom">
                    <div class="col-md-9">
                        ...
                        <div class="video-section play-auto-video">
                         ...
                         <iframe id="video" width="700" height="388" type="text/html" src="http://www.youtube.com/embed/Ib_IseMpI5w?rel=0&enablejsapi=1" frameborder="0" allowfullscreen ></iframe>
                        ...
                        <div class="video-wrap hide-wrap">   
                         ...
                         <iframe id="video" width="700" height="388" type="text/html" src="" frameborder="0" allowfullscreen ></iframe>
                        ...
                        echo $numUser; ?></h3>
                            ...
                            <div class="sidebar-panel align-center">
                                <a href="#">
                                    ...
                                    <?php echo $this->Html->image('sage-icons.png');?>
                ...
                <div class="panel margin-bottom">
                    ...
                    <p class="align-center font-BrandonGrotesque">Become a Founding TrepiCity Citizen now! <br>Let us profile the massive talent in our homegrown ecosystem and then take your awesomeness to the world!</p>
                </div>
                                ...
                                <div class="carousel-inner">
                                    ...
                                    echo $titleLen > 50 ? substr($advices['Advice']['advice_title'], 0, 50).'..':$advices['Advice']['advice_title'];?></h6>
                                         ...
                                         <?php //echo $this->Html->link('View Details', array('controller'=>'pages', 'action'=>'viewAdvice', $adviceId), array('class'=>'anchor-heading right'));?>
                                           ...
                                           <a href="#" class ="anchor-heading right get-data-modal" data-type = "Advice" data-id = <?php echo  $adviceId;?>>View Details</a> 
                                    </div>
                                    <?php } ?>  
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="box-wrap">
                                    ...
                                    <div class="box">
                                     ...
                                     <div class="sign-up-quote"><h5 class="font-narrow-bold">PLEASE HELP US TO MAKE THIS THE BEST EVER ONLINE ECOSYSTEM FOR ENTREPRENEURS ... SIGN UP NOW.</h5></div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="box-wrap">
                    ...
                    <div class="col-md-3">
                        <div class="side-panel">
                            <div class="side-panel-top purpel">
                                <i><?php echo $this->Html->image('seeker-hindsight-icon.png');?></i>
                                ...
                                <div class="carousel-inner">
                                 ...
                                 foreach($decisionbank as $key=>$decision_bank){
                                    ...
                                    <div class="item <?php echo $key == 0 ? 'active': '';?>">  
                                        ...
                                        <a href="#" class ="anchor-heading right get-data-modal" data-type = "Hindsight" data-id = <?php echo $decision_bank['DecisionBank']['id'];?> data-toggle="modal">View Details</a> 
