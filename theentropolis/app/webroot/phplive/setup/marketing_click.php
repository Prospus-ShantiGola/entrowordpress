...
<?php include_once( "./inc_header.php" ) ?>
					...
					print "
						<tr>
							...
							<td class=\"$td1\">
								...
								<div class=\"info_box\">example: http://www.your-website.com/?<span class=\"txt_blue\">&plk=pi-$marketing[marketID]-$marketing[skey]-m</span></div>
							</td>
						</tr>
					" ;
				}
		...
		<div class="edit_wrapper" style="padding: 5px; margin-top: 55px;">
			...
			<div style="margin-top: 10px;">
				...
				<tr>
					<td>Select Indication Color (reference color on the operator console traffic monitor)<br>
