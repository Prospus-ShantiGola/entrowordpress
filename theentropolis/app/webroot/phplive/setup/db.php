...
<?php include_once( "./inc_header.php" ) ?>
			...
			<div style="margin-top: 25px;">
				<div style="margin-bottom: 25px;"><img src="../pics/icons/arrow_left.png" width="16" height="15" border="0" alt=""> <a href="system.php">back</a></div>
				...
				<?php
					...
					for( $c = 0; $c < count( $tables ); ++$c )
					{
						...
						if ( preg_match( "/^p_/", $name ) )
						{
							...
							print "<tr><td class=\"td_dept_td_td\">$name</td><td class=\"td_dept_td_td\">$rows</td><td class=\"td_dept_td_td\">$ave_size</td><td class=\"td_dept_td_td\">$status</td></tr>" ;
						}
					}
					$approx_disc_use = Util_Functions_Bytes( $approx_disc_use ) ;
				?>
				<tr>
					<td colspan=4><div class="info_info">Disk Space Usage: <span style="font-weight: bold;" class="info_neutral">~<?php echo $approx_disc_use ?></span></div></td>
				</tr>
				</table>
			</div>
