		...
		<div style="display: none; margin-top: 25px;" id="extras_apis">
			...
			<div style="margin-top: 25px;">
				...
				<div style="margin-top: 25px;">
					...
					<div style="margin-top: 25px;">The following HTTP API URL will return the number of visitors currently on your website. (tracks pages that has the <a href="code.php">Standard HTML Code</a>)</div>
					<div style="margin-top: 5px;">
						<table cellspacing=0 cellpadding=0 border=0>
						<tr>
							<td class="td_dept_td">
					...
					<div style="margin-top: 5px;">
						...
						<?php else: ?>
						<tr><td class="td_dept_td" style="text-shadow: none;"><span class="info_error"><img src="../pics/icons/warning.png" width="12" height="12" border="0" alt=""> <a href="extras_geo.php" style="color: #FFFFFF;">Enable GeoIP Addon</a> for the GeoIP API.</span></td></tr>
						<?php endif ; ?>
						</table>
					</div>
