...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div style="text-shadow: none; margin-top: 25px; text-align: justify;">
			On pages that has the <a href="code.php">Standard or Text Link HTML Code</a>, the system will store the visitor's refer URL.  To conserve server resources and to optimize system response, the refer URLs data is stored for maximum of <b><?php echo $VARS_FOOTPRINT_STATS_EXPIRE ?> days</b>.  Reports greater then <b><?php echo $VARS_FOOTPRINT_STATS_EXPIRE ?> days</b> will be automatically cleared.  It is recommended to utilize a traffic statistics tool such as <a href="http://www.google.com/analytics/" target="_blank">Google Analytics</a> for a detailed website refer information.
		</div>
