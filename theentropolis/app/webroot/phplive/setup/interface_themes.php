...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div class="op_submenu_wrapper">
			<div class="op_submenu_focus" style="margin-left: 0px;">Themes</div>
					...
					<div style="text-shadow: none;">
						...
						<tr>
							...
							<td style="padding-left: 25px;">
								...
								<div style="margin-top: 5px;">* <a href="ops.php">chat operators</a> will also be able to select a theme for their operator console after <a href="ops.php?jump=online">logging in as the chat operator</a></div>
							</td>
						</tr>
						</table>
