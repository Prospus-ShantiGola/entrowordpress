			...
			<tr>
				<td colspan=2 style="padding-top: 15px;">
					<div class="info_neutral" style="text-shadow: none;">
						...
						<tr>
							<td><img src="../pics/icons/arrow_right.png" width="16" height="15" border="0" alt=""> Automatically delete the department saved offline message after &nbsp; </td>
							<td>
								...
								<div class="li_op round" style="color: #737373;"><input type="radio" id="savem_0" name="savem" value=0 onClick="do_savem(this.value)" <?php echo ( $deptinfo["savem"] == 0 ) ? "checked" : "" ?>> don't delete</div>
								<div style="clear: both;"></div>
							</td>
							<td></td>
						</tr>
						...
						<?php else: ?>
						<img src="../pics/icons/arrow_top.png" width="15" height="16" border="0" alt=""> Select a department to update the message delete setting.
						<?php endif ; ?>
					</div>
