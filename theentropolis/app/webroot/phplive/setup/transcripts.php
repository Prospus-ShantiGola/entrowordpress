...
<?php include_once( "./inc_header.php" ) ?>
		...
		<div id="transcripts_list" style="margin-top: 25px;">
			...
			<tr>
				...
				<td><div class="td_dept_header" style="<?php echo ( $tid ) ? "background: #D4FFD4; text-shadow: none;" : "" ; ?>">Question &nbsp; 
					...
					?>
					</select> <span style="padding-left: 15px;"><a href="transcripts_tags.php?jump=tags" style="<?php echo ( $tid ) ? "" : "" ; ?>"><img src="../pics/icons/add.png" width="12" height="12" border="0" alt=""> create tags</a></span>
				</div></td>
			</tr>
			<?php
					...
					if ( $transcript["opID"] )
					{
						...
						print "<tr id=\"tr_$transcript[ces]\" style=\"background: #$bg_color\">
							...
							<td class=\"$td1\">
								...
								<div style=\"margin-top: 5px; cursor: help;\" class=\"info_neutral\" alt=\"chat accept time\" title=\"chat accept time\"><img src=\"../pics/icons/clock2.png\" width=\"16\" height=\"16\" border=\"0\"> <span>$accepted_op</span></div>
							</td>
