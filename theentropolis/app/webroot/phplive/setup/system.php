...
<?php include_once( "./inc_header.php" ) ?>
			...
			<div class="op_submenu_wrapper">
				...
				<?php if ( $admininfo["adminID"] == 1 ): ?><div class="op_submenu" onClick="location.href='settings.php?jump=profile'" id="menu_profile"><img src="../pics/icons/key.png" width="12" height="12" border="0" alt=""> Setup Profile</div><?php endif ; ?>
			...
			<div style="margin-top: 25px;">
				...
				<div style="float: left; width: 750px;">
					...
					<div class="info_info">
						...
						<tr>
							<td nowrap><b>Software License Key:</b> <span class="info_box"><?php echo $KEY ?></span></td>
							<td width="100%" align="right" style="padding-left: 25px;"></td>
						</tr>
						<tr>
							<td colspan=2 style="padding-top: 25px;">
								<div class="info_blue" style="">
									<table cellspacing=0 cellpadding=2 border=0>
									<tr>
										<td width="150">PHP Live! <span class="info_box">v.<?php echo $VERSION ?></span></td><td><img src="../pics/icons/disc.png" width="16" height="16" border="0" alt=""> <a href="http://www.phplivesupport.com/r.php?plk=pi-24-ysj-m&r=vcheck&v=<?php echo base64_encode( $VERSION ) ?>&k=<?php echo base64_encode( $KEY ) ?>" target="new" style="color: #FFFFFF;">Click Here to check for new software version</a></td>
									</tr>
									</table>
								</div>
								<?php
								...
								<div class="info_neutral" style="margin-top: 15px;">
									<table cellspacing=0 cellpadding=2 border=0>
									<tr>
										<td width="150"><a href="extras_geo.php">GeoIP addon</a> <span class="info_box">v.<?php echo $VERSION_GEO ?></span></td><td><img src="../pics/icons/disc.png" width="16" height="16" border="0" alt=""> <a href="http://www.phplivesupport.com/r.php?r=vcheck_geo&v=<?php echo base64_encode( $VERSION_GEO ) ?>" target="new">check for new version</a></td>
									</tr>
									</table>
								</div>
								<?php endif ; ?>
				...
				<div style="float: left; border: 0px solid transparent; margin-left: 25px; text-align: right;">
					...
					<div style=""><a href="db.php"><img src="../pics/icons/db.png" width="16" height="16" border="0" alt=""> View Database Stats</a></div>
