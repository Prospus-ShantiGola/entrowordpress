<?php
	...
	FUNCTION Chat_remove_itr_OldRequests( &$dbh )
	{
		...
		$query = "SELECT SQL_NO_CACHE * FROM p_requests WHERE ( ( updated < $expired OR vupdated < $expired ) OR ( status = 1 AND ( updated < $expired_active OR vupdated < $expired_active ) ) ) AND op2op = 0" ;
