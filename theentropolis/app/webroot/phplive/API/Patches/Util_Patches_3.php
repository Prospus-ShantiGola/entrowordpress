<?php
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/98" ) )
	{ $patched = 98 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/99" ) )
	{ $patched = 99 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/100" ) )
	{ $patched = 100 ;
		$query = "ALTER TABLE p_req_log DROP INDEX created" ;
		database_mysql_query( $dbh, $query ) ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/104" ) )
	{ $patched = 104 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/105" ) )
	{ $patched = 105 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/112" ) )
	{ $patched = 112 ;
		Util_Vals_WriteVersion( "4.4.99.5" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ;
	}
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/113" ) )
	{ $patched = 113 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/117" ) )
	{ $patched = 117 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/124" ) )
	{ $patched = 124 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/125" ) )
	{ $patched = 125 ;
		Util_Vals_WriteVersion( "4.4.99.99" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ;
	}
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/126" ) )
	{ $patched = 126 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/131" ) )
	{ $patched = 131 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/132" ) )
	{ $patched = 132 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/136" ) )
	{ $patched = 136 ;
		Util_Vals_WriteVersion( "4.5.7" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ;
	}
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/137" ) )
	{ $patched = 137 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/138" ) )
	{ $patched = 138 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/139" ) )
	{ $patched = 139 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/140" ) )
	{ $patched = 140 ;
