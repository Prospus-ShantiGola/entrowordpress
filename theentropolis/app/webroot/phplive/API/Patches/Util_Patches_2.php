<?php
	...
	{ $patched = 52 ; Util_Vals_WriteVersion( "4.2.99-4" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/53" ) )
	{ $patched = 53 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/54" ) )
	{ $patched = 54 ; Util_Vals_WriteVersion( "4.2.99-6" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/55" ) )
	{ $patched = 55 ; Util_Vals_WriteVersion( "4.2.99-7" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/56" ) )
	{ $patched = 56 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/57" ) )
	{ $patched = 57 ; Util_Vals_WriteVersion( "4.2.99-9" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/58" ) )
	{ $patched = 58 ; Util_Vals_WriteVersion( "4.2.100" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/59" ) )
	{ $patched = 59 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/60" ) )
	{ $patched = 60 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/61" ) )
	{ $patched = 61 ; Util_Vals_WriteVersion( "4.2.103" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/62" ) )
	{ $patched = 62 ; Util_Vals_WriteVersion( "4.2.104" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/63" ) )
	{ $patched = 63 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/64" ) )
	{ $patched = 64 ; Util_Vals_WriteVersion( "4.2.106" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/65" ) )
	{ $patched = 65 ; Util_Vals_WriteVersion( "4.2.107" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/66" ) )
	{ $patched = 66 ; Util_Vals_WriteVersion( "4.2.108" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/67" ) )
	{ $patched = 67 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/68" ) )
	{ $patched = 68 ; Util_Vals_WriteVersion( "4.2.110" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/69" ) )
	{ $patched = 69 ; Util_Vals_WriteVersion( "4.2.111" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/70" ) )
	{ $patched = 70 ; Util_Vals_WriteVersion( "4.2.112" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/71" ) )
	{ $patched = 71 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/72" ) )
	{ $patched = 72 ; Util_Vals_WriteVersion( "4.2.114" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/73" ) )
	{ $patched = 73 ; Util_Vals_WriteVersion( "4.2.115" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/74" ) )
	{ $patched = 74 ; Util_Vals_WriteVersion( "4.2.116" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/75" ) )
	{ $patched = 75 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/76" ) )
	{ $patched = 76 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/77" ) )
	{ $patched = 77 ;
		touch( "$CONF[CONF_ROOT]/patches/$patched" ) ;
	}
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/78" ) )
	{ $patched = 78 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/79" ) )
	{ $patched = 79 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/80" ) )
	{ $patched = 80 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/81" ) )
	{ $patched = 81 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/82" ) )
	{ $patched = 82 ; Util_Vals_WriteVersion( "4.3.3" ) ; touch( "$CONF[CONF_ROOT]/patches/$patched" ) ; }
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/83" ) )
	{ $patched = 83 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/84" ) )
	{ $patched = 84 ;
	...
	else if ( !is_file( "$CONF[CONF_ROOT]/patches/85" ) )
	{ $patched = 85 ;
		...
		else if ( !isset( $CONF["SQLTYPE"] ) ) { Util_Vals_WriteToConfFile( "SQLTYPE", "SQL.php" ) ; }
