...
<?php include_once( "../../setup/inc_header.php" ) ?>
		...
		<div style="margin-top: 25px;">
			...
			<div style="margin-top: 15px;">Add additional expressiveness with emoticons of ecstatic, happy, thumbs up and more.  Emoticons <img src="smile.png" width="20" height="20" border="0" alt=""> will be visible on the chat window during an active chat session for both the visitor and the operator.</div>
