...
function preview_theme( thetheme, thewidth, theheight, thedeptid )
{
	...
	var win_preview = window.open( "../phplive.php?d="+thedeptid+"&theme="+thetheme+"&"+unique, "theme_preview", 'scrollbars=no,resizable=yes,menubar=no,location=no,screenX=50,screenY=100,width='+thewidth+',height='+theheight, thetarget, "location=yes" ) ;
	win_preview.focus() ;
}
