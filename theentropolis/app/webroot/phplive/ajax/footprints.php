<?php
	...
	else
	{
		...
		$nresults = Footprints_put_Print_U( $dbh, $c, $vis_token, 0, $os, $browser, $footprints, $requests, $initiates, $resolution, $ip, $onpage, $title, $marketid, $refer, $country, $region, $city, $latitude, $longitude ) ;
