...
<!--
	...
	{
		$('#'+thetable+' tr:nth-child(1n+2)').addClass('chat_info_tr_traffic_row') ;
	}
				...
				if ( json_data.status )
				{
					...
					var traffic_string = "<table cellspacing=0 cellpadding=0 border=0 width=\"98%\" id=\"table_trs_traffic\">"+
						"<tr>"+
							...
							"<td width=\"45\"><div class=\"chat_info_td_t\" style=\"margin-right: 0px; cursor: help;\" title=\"Total Footprints\" alt=\"Total Footprints\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/info.png\" width=\"10\" height=\"10\" border=\"0\" title=\"Total Footprints\" alt=\"Total Footprints\"> t-f</div></td>"+
							"<td width=\"45\"><div class=\"chat_info_td_t\" style=\"margin-right: 0px; cursor: help;\" title=\"Total Chat Requests\" alt=\"Total Chat Requests\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/info.png\" width=\"10\" height=\"10\" border=\"0\" title=\"Total Chat Requests\" alt=\"Total Chat Requests\"> t-c</div></td>"+
							"<td width=\"110\"><div class=\"chat_info_td_t\" style=\"margin-right: 0px; cursor: help;\" title=\"Total Operator Chat Invite\" alt=\"Total Operator Chat Invite\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/info.png\" width=\"10\" height=\"10\" border=\"0\" title=\"Total Operator Chat Invite\" alt=\"Total Operator Chat Invite\"> t-i</div></td>"+
							"<td><div class=\"chat_info_td_t\" style=\"margin-right: 0px; white-space: nowrap;\">On Page</div></td>"+
					...
					for ( var c = 0; c < json_data.traffics.length; ++c )
					{
						...
						image = "actions.png?<?php echo $VERSION ?>" ; image_info = "&nbsp;" ;
						...
						traffic_string += "<tr style=\"\">"+
								"<td class=\"chat_info_td_traffic\" title=\"View Visitor Details\" alt=\"View Visitor Details\" id=\"td_"+json_data.traffics[c]["vis_token"]+"\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/"+image+"\" border=\"0\" alt=\"\" style=\"cursor: pointer;\" "+image_info+" onClick=\"expand_footprint('"+json_data.traffics[c]["vis_token"]+"', '"+json_data.traffics[c]["duration"]+"', '"+market_name+"', '"+json_data.traffics[c]["ip"]+"', '"+json_data.traffics[c]["os"]+"', '"+json_data.traffics[c]["browser"]+"', '"+json_data.traffics[c]["resolution"]+"', '"+json_data.traffics[c]["t_footprints"]+"', '"+json_data.traffics[c]["t_requests"]+"', '"+json_data.traffics[c]["t_initiates"]+"', '"+json_data.traffics[c]["title"]+"', '"+json_data.traffics[c]["onpage"]+"', '"+json_data.traffics[c]["refer_snap"]+"', '"+json_data.traffics[c]["refer_raw"]+"', '"+json_data.traffics[c]["country"]+"', '"+json_data.traffics[c]["region"]+"', '"+json_data.traffics[c]["city"]+"', 0 )\" id=\"footprint_"+json_data.traffics[c]["vis_token"]+"\"></td>"+
								"<td class=\"chat_info_td_traffic\" nowrap>"+json_data.traffics[c]["duration"]+"</td>"+market_td+td_map+td_viewip+
								"<td class=\"chat_info_td_traffic\" style=\"text-align: center;\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/os/"+json_data.traffics[c]["os"]+".png\" border=0 alt=\""+json_data.traffics[c]["os"]+"\" title=\""+json_data.traffics[c]["os"]+"\" width=\"14\" height=\"14\"> &nbsp; <img src=\"../themes/<?php echo $opinfo["theme"] ?>/browsers/"+json_data.traffics[c]["browser"]+".png\" border=0 alt=\""+json_data.traffics[c]["browser"]+"\" title=\""+json_data.traffics[c]["browser"]+"\" width=\"14\" height=\"14\"></td>"+
								...
								"<td class=\"chat_info_td_traffic\" nowrap><div title=\"Total Operator Chat Invites\" alt=\"Total Operator Chat Invites\"><button type='button' style='font-size: 10px; padding: 2px;' onClick=\"expand_footprint('"+json_data.traffics[c]["vis_token"]+"', '"+json_data.traffics[c]["duration"]+"', '"+market_name+"', '"+json_data.traffics[c]["ip"]+"', '"+json_data.traffics[c]["os"]+"', '"+json_data.traffics[c]["browser"]+"', '"+json_data.traffics[c]["resolution"]+"', '"+json_data.traffics[c]["t_footprints"]+"', '"+json_data.traffics[c]["t_requests"]+"', '"+json_data.traffics[c]["t_initiates"]+"', '"+json_data.traffics[c]["title"]+"', '"+json_data.traffics[c]["onpage"]+"', '"+json_data.traffics[c]["refer_snap"]+"', '"+json_data.traffics[c]["refer_raw"]+"', '"+json_data.traffics[c]["country"]+"', '"+json_data.traffics[c]["region"]+"', '"+json_data.traffics[c]["city"]+"', 1 )\">chat invite</button> "+json_data.traffics[c]["t_initiates"]+"</div></td>"+
	...
	function populate_requestinfo( theip, thevis_token, thecountry, theregion, thecity )
	{
		...
		success: function(data){
			...
			init_trs( 'table_trs_traffic_info' ) ;
		},
		error:function (xhr, ajaxOptions, thrownError){
			...
			if ( json_data.status )
			{
				var transcripts_string = "<table cellspacing=0 cellpadding=0 border=0 width=\"98%\" id=\"table_trs_trans\"> "+
					"<tr>"+
						...
						"<td width=\"180\"><div class=\"chat_info_td_t\">Operator</div></td>"+
				...
				for ( var c = 0; c < json_data.transcripts.length; ++c )
				{
					...
					transcripts_string += "<tr><td class=\"chat_info_td_traffic\" width=\"16\" id=\"img_"+json_data.transcripts[c]["ces"]+"\" style=\"cursor: pointer;\"><img src=\"../themes/<?php echo $opinfo["theme"] ?>/view.png\" onClick=\"parent.open_transcript('"+json_data.transcripts[c]["ces"]+"')\" width=\"16\" height=\"16\" title=\"view transcript\" alt=\"view transcript\"></td><td class=\"chat_info_td_traffic\">"+json_data.transcripts[c]["operator"]+"</td><td class=\"chat_info_td_traffic\">"+json_data.transcripts[c]["vname"]+rating_stars+"</td><td class=\"chat_info_td_traffic\" nowrap>"+json_data.transcripts[c]["created"]+"</td><td class=\"chat_info_td_traffic\" nowrap>"+json_data.transcripts[c]["duration"]+"</td><td class=\"chat_info_td_traffic\">"+strip_tags( json_data.transcripts[c]["question"] )+"</td></tr>" ;
				}
					...
					<?php if ( $CONF['icon_check'] == "on" ): ?>
						...
						<div style="padding-top: 25px;">
							...
							<div style="margin-top: 5px;">
								...
								&nbsp;
								<button type="button" onClick="initiate_chat()" id="btn_initiate">Invite to chat.</button>
							</div>
						</div>
					<?php else: ?>
