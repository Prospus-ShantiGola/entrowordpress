...
<!--
	...
	$(document).ready(function()
	{
		...
		populate_ops_op2op() ;
		si_op2op = setInterval(function(){
			location.href = "op_op2op.php?action=reload" ;
		}, 45000) ;
			...
			if ( json_data.status )
			{
				...
				for ( var c = 0; c < json_data.departments.length; ++c )
				{
					...
					for ( var c2 = 0; c2 < json_data.departments[c].operators.length; ++c2 )
					{
						...
						var button = "" ;
						var chatting_with = ( <?php echo $opinfo["nchats"] ?> ) ? " chatting with "+json_data.departments[c].operators[c2]["requests"]+" visitors" : "" ;
	...
	<div style="">
		...
		<tr>
			<td width="60%" valign="top">
				<div style="margin-bottom: 10px; font-size: 14px; font-weight: bold;"><img src="../themes/<?php echo $opinfo["theme"] ?>/info_chats.gif" width="10" height="10" border="0" alt=""> Departments</div>
				<div id="canned_body" style="height: 300px; overflow-y: auto;"></div>
			</td>
			<td width="40%" valign="top" style="padding-left: 15px;">
				<div style="margin-bottom: 10px; font-size: 14px; font-weight: bold;"><img src="../themes/<?php echo $opinfo["theme"] ?>/info_initiate.gif" width="10" height="10" border="0" alt=""> Operators</div>
