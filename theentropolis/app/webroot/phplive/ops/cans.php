...
<?php include_once( "./inc_header.php" ) ; ?>
		...
		<div id="div_cans_new" style="display: none;">
			<div style="font-size: 12px; font-weight: normal;"><img src="../pics/icons/info.png" width="14" height="14" border="0" alt=""> Canned responses created here will be available to you only.</div>
