<?php
	...
	else
	{
		...
		$geo_country = ( $geo_country_code != "unknown" ) ? $countries[$geo_country_code] : "Unknown" ;
		$geo_region = ( isset( $geoinfo["region"] ) && $geoinfo["region"] ) ? $geoinfo["region"] : "unknown" ;
		$geo_city = ( isset( $geoinfo["city"] ) && $geoinfo["city"] ) ? $geoinfo["city"] : "unknown" ;
...
<body id="chat_info_body" style="margin: 0px; border: 0px; padding: 0px;">
	...
	<div id="map_default" style="display: none; height: 100%;">
		...
		<?php else: ?>
			...
			<?php else: ?>
			<div class="chat_info_td" style="padding: 10px; text-align: justify;">To enable GeoIP Location, contact the setup admin.  The setup admin will need to login to the setup area and access the top menu "Extras".  On the "Extras" page, click the "GeoIP" sub menu.</td>
			<?php endif ; ?>
