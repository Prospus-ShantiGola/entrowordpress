...
CKEDITOR.plugins.add("wordcount", {
    ...
    init: function (editor) {
        ...
        function limitReached(editorInstance, notify) {
            ...
            if (!notify) {
				alert("Maximum Words allowed are " + config.maxWordCount + " words! Please type " + config.maxWordCount +" words only");
        ...
        function updateCounter(editorInstance) {
            ...
            var html = format.replace("%wordCount%", wordCount).replace("%paragraphs%", paragraphs);
