...
//$baseUrl = '/ckfinder/userfiles/';
 ...
 $baseUrl = 'http://192.168.1.15/entropolis/app/webroot/files/ckuploads/';//as we want to have all of our files under webrrot/files/ckuploads folder
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/app/webroot/files/ckuploads/images/';
