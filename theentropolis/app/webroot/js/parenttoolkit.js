...
//$(window).load(function () {
    $('#btnSearch').click(function () {
        ...
        $.ajax({
            url: "ParentToolkits/search_files/1",
            data: postForm,
            type: 'POST',
    ...
    $('#btnSearchEdit').click(function () {
        ...
        $.ajax({
            url: "../ParentToolkits/search_files",
            data: postForm,
            type: 'POST',
            success: function (data) {
                if (data.result == "error") {
    ...
    var addFormValidation = $('#ToolkitAddForm').validate(
            {
                ...
                rules: {
                    'data[ParentToolkit][name]': {
                        required: true,
                        maxlength: 200
                    },
                    'data[ParentToolkit][short_description]': {
                        maxlength: 200
                    },
                    'data[ParentToolkit][description]': {
                        maxlength: 400
                    }
                },
        ...
        buttons: {
            success: {
                ...
                callback: function () {
                    $.ajax({
                        type: 'POST',
                        url: 'ParentToolkits/delete/' + folder_id,
                        success: function (data) {
                            if (data.result == "error") {
                                bootbox.alert({
                                    title: "Error!!",
...
var fileDirectoryModule = (function () {
    ...
    return {
        ...
        editFolder: function () {
            ...
            $('#ToolkitEditForm [name="data[ParentToolkit][id]"]').val(input.data("id"));
            $('#ToolkitEditForm [name="data[ParentToolkit][name]"]').val(folderName);
            $('#ToolkitEditForm #ParentToolkitShortDescription').val(folderTitle);
        },
        editDescription: function () {
            ...
            $('#EditDescPopup #ParentToolkitDescription').val(folderDesc);
        },
        editFile: function (selector) {
            ...
            $('#ToolkitEditFileForm [name="data[ParentToolkit][id]"]').val(currentElm.data("id"));
            $('#ToolkitEditFileForm [name="data[ParentToolkit][old_name]"]').val(fileName);
            $('#ToolkitEditFileForm [name="data[ParentToolkit][title]"]').val(fileName);
            $('#ToolkitEditFileForm #ParentToolkitShortDescription').val(fileTitle);
        },
        ...
        buttons: {
            success: {
                ...
                callback: function () {
                    $.ajax({
                        type: 'POST',
                        url: '../ParentToolkits/delete_file/',
                        data: postForm,
                        success: function (data) {
                            if (data.result == "error") {
                                bootbox.alert({
...
$("#ToolkitEditDescription").submit(function () {
    ...
    $.ajax({
        url: "../ParentToolkits/edit_description",
        data: datas,
        type: 'POST',
        success: function (data) {
            if (data.result == "error") {
...
// form validation of video upload
    var validatorVideo = $('#ToolkitAddVideoForm').validate(
            {
                errorClass: "fileupload-error-fields",
                rules: {
                    'data[ParentToolkit][video_url]': {
                        required: true,
                        url: true
                    },
                    'data[ParentToolkit][title]': {
                        required: true
                    }
                },
                submitHandler: function (form) {
    ...
    var editFolderValidator = $('#ToolkitEditForm').validate({
        ...
        submitHandler: function (form) {
            ...
            var datas = $('#ToolkitEditForm').serialize();
            $.ajax({
                url: "../ParentToolkits/edit_folder",
                data: datas,
                type: 'POST',
                success: function (data) {
                    if (data.result == "error") {
