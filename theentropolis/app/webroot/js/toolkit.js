    ...
    var addFormValidation = $('#ToolkitAddForm').validate(
            {
                ...
                rules: {
                    ...
                    'data[Toolkit][short_description]': {
                        maxlength: 200
                    },
        ...
        buttons: {
            success: {
                ...
                callback: function () {
                    $.ajax({
                        type: 'POST',
                        url: '/trepicity/toolkits/delete/' + folder_id,
                        success: function (data) {
                            if (data.result == "error") {
                                bootbox.alert({
                                    title: "Error!!",
...
var fileDirectoryModule = (function () {
    ...
    return {
        ...
        editFolder: function () {
            ...
            $('#ToolkitEditForm [name="data[Toolkit][id]"]').val(input.data("id"));
            $('#ToolkitEditForm [name="data[Toolkit][name]"]').val(folderName);
            $('#ToolkitEditForm #ToolkitShortDescription').val(folderTitle);
        },
        editDescription: function () {
            ...
            $('#EditDescPopup #ToolkitDescription').val(folderDesc);
        },
        editFile: function (selector) {
            ...
            $('#ToolkitEditFileForm [name="data[Toolkit][id]"]').val(currentElm.data("id"));
            $('#ToolkitEditFileForm [name="data[Toolkit][old_name]"]').val(fileName);
            $('#ToolkitEditFileForm [name="data[Toolkit][title]"]').val(fileName);
            $('#ToolkitEditFileForm #ToolkitShortDescription').val(fileTitle);
        },
...
/*$("#upload_files").submit(function () {
 ...
 $.ajax({
 url: 'toolkits/add_file', // point to server-side PHP script 
